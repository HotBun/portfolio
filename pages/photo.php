...
<body>
  ...
  <div class="container">
   <div class="row">
    <div class="block__margin">
     <?php  
          $views = mysqli_query($connection, "SELECT * FROM `articles` WHERE `id` = 2");
      ...
      <?php
                     //Пагинация и вывод записей
                      ...
                      $total_count_q = mysqli_query($connection, "SELECT COUNT(`id`) AS `total_count` FROM `articles` WHERE `categories_id` = 2 ");
                      ...
                      $categories = mysqli_query($connection, "SELECT * FROM `articles_categories` WHERE `id` = 2 ORDER BY `id`");
                      ...
                      while( $art = mysqli_fetch_assoc($articles)){
                        ?>
                        <?php  
                        $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id` = 2 ORDER BY `id`  DESC LIMIT $offset,$per_page ");
                        ?>
                        <?php 
                        while($art = mysqli_fetch_assoc($articles) ){
                          ?>
                       ...
                       <div class="row">
                        <div class="col-md-12">
                         ...
                         <ul class="pagination pagination-lg">
                          ...
                          <li><a href="photo.php?page=<?= $p ?>"><?= $p ?></a></li>
                          <?php } ?>
                        </ul>
                        <?php } ?>
                      </div><!--col-md-12-->
