...
<body>
  ...
  <div class="container">
   <div class="row">
    <div class="block__margin">
     <?php  
          $views = mysqli_query($connection, "SELECT * FROM `articles` WHERE `id` = 4");
      ...
      <?php
                     //Пагинация и вывод записей
                      ...
                      $total_count_q = mysqli_query($connection, "SELECT COUNT(`id`) AS `total_count` FROM `articles` WHERE `categories_id` = 4 ");
                      ...
                      $categories = mysqli_query($connection, "SELECT * FROM `articles_categories` WHERE `id` = 4 ORDER BY `id`");
                      ...
                      while( $art = mysqli_fetch_assoc($articles)){
                        ?>
                        <?php  
                        $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id` = 4 ORDER BY `id`  DESC LIMIT $offset,$per_page ");
                        ?>
                        <?php 
                        while($art = mysqli_fetch_assoc($articles) ){
                          ?>
                          <div class= "col-md-4 col-sm-6 col-xs-12 articles">
                            ...
                            <span class="articles__section__photoshop"><span class="articles__title__name">Раздел: </span><?php echo $cat['title']; ?></span>
                       ...
                       <div class="row">
                        <div class="col-md-12">
                         ...
                         <ul class="pagination pagination-lg">
                          ...
                          <li><a href="illustrator.php?page=<?= $p ?>"><?= $p ?></a></li>
                          <?php } ?>
                        </ul>
                        <?php } ?>
                      </div><!--col-md-12-->
