   ...
   <div class="row">
    <div class="block__margin">
      <div class="container">
        <div class="row">
          <?php  
          $views = mysqli_query($connection, "SELECT * FROM `articles` WHERE `id` = 5");
      ...
      <?php
                     //Пагинация и вывод записей
                      ...
                      $total_count_q = mysqli_query($connection, "SELECT COUNT(`id`) AS `total_count` FROM `articles` WHERE `categories_id` = 5 ");
                      ...
                      $categories = mysqli_query($connection, "SELECT * FROM `articles_categories` WHERE `id` = 5 ORDER BY `id`");
                      ...
                      while( $art = mysqli_fetch_assoc($articles)){
                      	?>
                      	<?php  
                      	$articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id` = 5 ORDER BY `id`  DESC LIMIT $offset,$per_page ");
                      	?>
                      	<?php 
                      	while($art = mysqli_fetch_assoc($articles) ){
                      		?>
                     ...
                     <div class="row">
                      <div class="col-md-12">
                       ...
                       <ul class="pagination pagination-lg">
                        ...
                        <li><a href="photoshop.php?page=<?= $p ?>"><?= $p ?></a></li>
                        <?php } ?>
                      </ul>
                      <?php } ?>
                    </div><!--col-md-12-->
